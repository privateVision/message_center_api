...
class OauthController extends Controller {
    ...
    public function getRegisterUser() {
        ...
        if(!$ctype) {
            throw new ApiException(ApiException::Error, '未知的登录类型:'.$type); // LANG:unknow_login_type_3th
        }
    ...
    public function getLoginUser() {
        ...
        if(!$user_oauth) {
            throw new ApiException(ApiException::OauthNotRegister, "尚未注册第三方账号，请先注册"); // LANG:not_register_3th
        }
