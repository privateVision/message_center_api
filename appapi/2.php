...
$lang = [
    ...
    '\'未知的第三方登录类型，type=\'.$type' => '3th_unknow',
    '"unionid不允许为空"' => 'unionid_empty',
    '\'未知的第三方登录类型，type=\'.$type' => '3th_unknow',
    '"尚未注册"' => 'not_register',
    ...
    '\'"_appid" not exists:\' . $_appid' => 'invalid_appid',
    '"签名验证失败"' => 'sign_error',
    ...
    '\'银联支付请求失败 \' . $resdata[\'respMsg\']' => 'unionpay_fail_1',
    '\'发起支付失败\'' => 'pay_fail',
    '\'发起支付失败\'' => 'pay_fail',
    '\'发起支付失败（\'.$responseData[\'return_msg\'].\'）\'' => 'pay_fail_1',
    ...
    '\'"_appid" not exists:\' . $_appid' => 'invalid_appid',
    '"签名验证失败"' => 'sign_error',
    '"__appid not found:{$_appid}"' => 'invalid_appid',
    ...
    '"unionid不允许为空"' => 'unionid_empty',
    '"账号已经绑定了" . config("common.oauth.{$type}.text", \'第三方\')' => '3th_already_bind',
    'config("common.oauth.{$type}.text", \'第三方\') . "已经绑定了其它账号"' => '3th_already_bind_other',
    '"为了防止遗忘账号，请绑定手机或者其他社交账号后再解除绑定"' => '3th_unbind_error',
    '\'头像上传失败：\' . $e->getMessage()' => 'avatar_set_error',
    '\'设置失败，用户名已被占用\'' => 'username_exists_onset',
    '"验证码不正确，或已过期"' => 'invalid_smscode',
    '"参数\"{$key}\"格式不正确"' => 'param_format_error',
    '\'param is missing:"\'.$key.\'"\'' => 'param_missing',
    '"参数\"{$key}\"格式不正确"' => 'param_format_error',
    '"\"{$mobile}\" 不是一个有效的手机号码"' => 'mobile_format_error',
