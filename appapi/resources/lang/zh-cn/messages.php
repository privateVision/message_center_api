...
return [
    ...
    'order_not_exists'                      => '未找到订单',
    'product_not_exists'                    => '未找到相关的商品',
    'notifyurl_error'                       => '请填写正确的通知地址',
    'bundle_ipa_not_exists'                 => 'bundle_id 或iap 不存在',
    ...
    'func_disable'                          => '该功能已停用',
    'invalid_smscode'                       => '绑定失败，验证码不正确，或已过期',
    'user_already_bind_mobile'              => '该账号已经绑定了手机号码',
    'not_bind_onunbind'                     => '还未绑定手机号码，无法解绑',
    'invalid_smscode'                       => '手机号码解绑失败，验证码不正确，或已过期',
